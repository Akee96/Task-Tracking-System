        ...
        this._initialize = function () {
            if (!this._initialized) {
                ...
                if (!styled) {
                    styled = true;
                    styles = [
                        '.jstree-table-cell {vertical-align: top; overflow:hidden;margin-left:0;width: 100%;padding-left:7px;white-space: nowrap; cursor: default; text-overflow: ellipsis;line-height: 24px;min-height: 24px;}',
                        '.jstree-table-cell span {margin-right:0px;margin-right:0px;*display:inline;*+display:inline;white-space: nowrap;max-width:none !important}',
                        ...
                        '.jstree-table-header-cell {display: table-cell; overflow: hidden; white-space: nowrap;padding: 4px 3px 2px 5px; cursor: default;max-width:none !important}',
...
/*change 10 ->100 */	'.jstree-table-resizable-separator {cursor: col-resize; width: 10px;}',
/*removed border-color: #d0d0d0; border-style: solid;*/						'.jstree-table-separator-regular {}',
...
/*diplay table cell to inlin */    						'.jstree-table-column {display: inline-table; overflow: hidden;max-width: none !important;}',
        ...
        this._prepare_headers = function () {
            ...
            this.headerWrapper.on("contextmenu", ".jstree-table-header-cell", function (e) {
                ...
                var options = {
                    "fit": {
                        label: "Size column to fit", "action": function (data) {
                    ...
                    "fitAll": {
                        "separator_after": true, label: "Size all columns to fit", "action": function (data) {
                ...
                _this.midWrapper.find(".jstree-table-header-cell").each(function () {
                    ...
                    options[value] = {
                        icon: icon, column: value, label: label, _disabled: (value === 'text'), "action": function (data) {
...
/*headwe widtth*/			var headerCol = $('.jstree-table-headerwrapper>div').eq(index);
        ...
        this._prepare_table = function (obj) {
            ...
            if (a.length === 1) {
                ...
                // if there is no width given for the last column, do it via automaticS
                if (cols[cols.length - 1].width === undefined) {
                    last.addClass("jstree-table-width-auto").next(".jstree-table-separator").remove();
                }
            }
